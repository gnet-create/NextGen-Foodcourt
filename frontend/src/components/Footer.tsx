          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <span className="w-5 h-5 text-orange-400">location</span>
                <span className="text-gray-400 text-lg">NextGen FoodCourt, Level 2</span>
              </div>
              <div className="flex items-center space-x-3">
               <span className="w-5 h-5 text-orange-400">Phone</span>

                <span className="text-gray-400 text-lg">+254 700 123 456</span>
              </div>
              <div className="flex items-center space-x-3">
               <span className="w-5 h-5 text-orange-400">mail</span>
